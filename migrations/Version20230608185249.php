 ...
 */
final class Version20230608185249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, nb_doors INT NOT NULL, nb_seats INT NOT NULL, cost DOUBLE PRECISION NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_773DE69D12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
